...
for dr in dropout:
    ...
    checkpoint_encoder_pth = f'./data_hcp/wgan-gp-sc_hcp_fluid-intelligence/dr_{dr}/checkpoint_encoder.pth'
    checkpoint_decoder_pth = f'./data_hcp/wgan-gp-sc_hcp_fluid-intelligence/dr_{dr}/checkpoint_decoder.pth'
    ...
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/training_latent_space_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/training_latent_space_pca_dr_{dr}.png', dpi=700)
    ...
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/training_latent_score_corr_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/training_latent_score_corr_pca_dr_{dr}.png', dpi=700)
    ...
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/validation_latent_space_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/validation_latent_space_pca_dr_{dr}.png', dpi=700)
    ...
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/validation_latent_score_corr_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc_hcp_fluid-intelligence/validation_latent_score_corr_pca_dr_{dr}.png', dpi=700)
