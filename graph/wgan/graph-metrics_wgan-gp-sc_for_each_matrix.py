...
checkpoint_encoder_pth = f'../../wgan/data/wgan-gp-sc/dr_{dropout}/checkpoint_encoder.pth'
checkpoint_decoder_pth = f'../../wgan/data/wgan-gp-sc/dr_{dropout}/checkpoint_decoder.pth'
...
fig.savefig(f'../fig/graph_metrics/wgan-gp-sc_betweenness_centrality.pdf', transparent=True)
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
fig.savefig(f'../fig/graph_metrics/wgan-gp-sc_cluster_coefficient.pdf', transparent=True)
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
fig.savefig(f'../fig/graph_metrics/wgan-gp-sc_local_efficiency.pdf', transparent=True)
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
fig.savefig(f'../fig/graph_metrics/wgan-gp-sc_global_efficiency.pdf', transparent=True)
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
fig.savefig(f'../fig/graph_metrics/wgan-gp-sc_modularity.pdf', transparent=True)
