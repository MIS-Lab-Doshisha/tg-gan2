...
for dr in dropout:
    for a in alphas:
        ...
        checkpoint_encoder_pth = f'../../tg-gan-2/data/tg-gan-sc/dr_{dr}_alpha_{a}/checkpoint_encoder.pth'
        checkpoint_decoder_pth = f'../../tg-gan-2/data/tg-gan-sc/dr_{dr}_alpha_{a}/checkpoint_decoder.pth'
        ...
        for ed in edge_density:
            ...
            ax = plot_connectivity_matrix(fig=fig, ax=ax, matrix=real_mean, cmap='gist_heat', vmin=0, vmax=10)

            ax = fig.add_subplot(1, 2, 2)
            ax = plot_connectivity_matrix(fig=fig, ax=ax, matrix=real_bin, cmap='gray', vmin=0, vmax=1)

            fig.savefig(f'../fig/acquired_connectivity_matrix_edge_density_{ed}.pdf', transparent=True)
            ...
            fig.savefig(f'../fig/tg-gan-2-sc_connectivity_matrix_edge_density_{ed}.pdf', transparent=True)
        ...
        df_edge_strength_real_melt['kind'] = 'acquired'
        df_edge_strength_fake_melt = pd.melt(df_edge_strength_fake)
        df_edge_strength_fake_melt['kind'] = 'synthesized'
        ...
        fig.savefig('../fig/tg-gan-2-sc_edge_strength.pdf', transparent=True)
        ...
        df_between_centrality_real_melt['kind'] = 'acquired'
        df_between_centrality_fake_melt = pd.melt(df_between_centrality_fake)
        df_between_centrality_fake_melt['kind'] = 'synthesized'
        ...
        fig.savefig('../fig/tg-gan-2-sc_between-centrality.pdf', transparent=True)
        ...
        df_cluster_coefficient_real_melt['kind'] = 'acquired'
        df_cluster_coefficient_fake_melt = pd.melt(df_cluster_coefficient_fake)
        df_cluster_coefficient_fake_melt['kind'] = 'synthesized'
        ...
        fig.savefig('../fig/tg-gan-2-sc_cluster-coefficient.pdf', transparent=True)

        # graph metrics
        graph_metrics_txt = f'./tg-gan-2-sc_graph-metrics_dr_{dr}_alpha_{a}.txt'
