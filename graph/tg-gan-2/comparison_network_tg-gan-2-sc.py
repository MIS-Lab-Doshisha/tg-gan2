...
for dr in dropout:
    for a in alphas:
        ...
        fig.savefig('../fig/tg-gan-2-sc_difference_matrix.pdf', transparent=True)
        ...
        fig.savefig('../fig/tg-gan-2-sc_difference_connectome_left-right.pdf', transparent=True)
        ...
        fig.savefig('../fig/tg-gan-2-sc_difference_connectome_left-left.pdf', transparent=True)
        ...
        fig.savefig('../fig/tg-gan-2-sc_difference_connectome_right-right.pdf', transparent=True)
        ...
        fig = plt.figure()
        ax = fig.add_subplot()
        ax = plot_connectivity_matrix(fig=fig, ax=ax, matrix=difference_matrix_subcor_subcor, vmin=-0.5, vmax=0.5, cmap=cmap)
        ...
        fig.savefig('../fig/tg-gan-2-sc_difference_connectome_subcor-subcor.pdf', transparent=True)
        ...
        fig = plt.figure()
        ax = fig.add_subplot()
        ax = plot_connectivity_matrix(fig=fig, ax=ax, matrix=difference_matrix_non_subcor_subcor, vmin=-0.5, vmax=0.5, cmap=cmap)
        ...
        fig.savefig('../fig/tg-gan-2-sc_difference_connectome_non-subcor-subcor.pdf', transparent=True)
