...
for dr in dropout_rate:
    for a in alphas:
        ...
        critics = Critics(n_regions=116, dr_rate=dr)
        regressor = BrainNetCNN(n_regions=116, dr_rate=dr)
        ...
        test_matrix = test_matrix.reshape((len(test_matrix), 1, 116, 116))
        ...
        for epoch in range(n_epochs):
            ...
            fake = fake.reshape(len(fake), 116, 116)
