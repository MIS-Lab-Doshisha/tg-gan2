...
train_datasets = NIMHSC(participants_csv='../data/nihtoolbox_disc_train.csv', target='nihtoolbox', transforms=transform,
...
for dr in dropout:
    for a in alphas:
        ...
        fig.savefig(f'./fig/tg-gan-2-sc/modified_training_latent_space_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc/modified_training_latent_space_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig/tg-gan-2-sc/modified_training_latent_score_corr_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc/modified_training_latent_score_corr_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig/tg-gan-2-sc/modified_validation_latent_space_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc/modified_validation_latent_space_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig/tg-gan-2-sc/modified_validation_latent_score_corr_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc/modified_validation_latent_score_corr_pca_dr_{dr}_alpha_{a}.png', dpi=700)
