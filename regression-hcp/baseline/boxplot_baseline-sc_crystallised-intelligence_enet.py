...
test_mse.to_csv('./baseline_sc_crystallised-intelligence_enet_test_mse.csv')
test_r.to_csv('./baseline_sc_crystallised-intelligence_enet_test_pearson-r.csv')
...
fig.savefig('./fig/baseline_sc_crystallised-intelligence_enet_test_rmse.pdf', transparent=True)
fig.savefig('./fig/baseline_sc_crystallised-intelligence_enet_test_rmse.png', dpi=700)
...
fig.savefig('./fig/baseline_sc_crystallised-intelligence_enet_test_r.pdf', transparent=True)
fig.savefig('./fig/baseline_sc_crystallised-intelligence_enet_test_r.png', dpi=700)
