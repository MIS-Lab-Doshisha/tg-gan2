...
hcp_crystallised_intelligence_train_csv = '../../data_hcp/hcp-cognition/hcp_crystallised-intelligence/hcp_crystallised-intelligence_prediction-model_train_4.csv'
...
# Save as pickle
result_dir = f'./data/baseline-sc_train_4_crystallised-intelligence/ridge/outer_{n_outer_splits}_inner_{n_inner_splits}'
