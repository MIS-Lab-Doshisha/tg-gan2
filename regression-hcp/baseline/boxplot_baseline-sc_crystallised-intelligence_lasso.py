...
fig.savefig('./fig/baseline_sc_crystallised-intelligence_lasso_test_rmse.pdf', transparent=True)
fig.savefig('./fig/baseline_sc_crystallised-intelligence_lasso_test_rmse.png', dpi=700)
...
fig.savefig('./fig/baseline_sc_crystallised-intelligence_lasso_test_r.pdf', transparent=True)
fig.savefig('./fig/baseline_sc_crystallised-intelligence_lasso_test_r.png', dpi=700)
