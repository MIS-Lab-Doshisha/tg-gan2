...
for i in n_splits:
    b_train_score_pkl = f'./data/baseline-sc_train_{i}_fluid-intelligence/{algorithm}/outer_{n_outer_splits}_inner_{n_inner_splits}/score.pkl'
...
# ------ Score plot ------ #
# baseline_sc_fluid-intelligence
...
test_mse.to_csv('./baseline_sc_fluid-intelligence_enet_test_mse.csv')
test_r.to_csv('./baseline_sc_fluid-intelligence_enet_test_pearson-r.csv')
...
fig.savefig('./fig/baseline_sc_fluid-intelligence_enet_test_rmse.pdf', transparent=True)
fig.savefig('./fig/baseline_sc_fluid-intelligence_enet_test_rmse.png', dpi=700)
...
fig.savefig('./fig/baseline_sc_fluid-intelligence_enet_test_r.pdf', transparent=True)
fig.savefig('./fig/baseline_sc_fluid-intelligence_enet_test_r.png', dpi=700)

# T-test [baseline < baseline_sc_fluid-intelligence]
print('Pearson r')
p_val = []
for i, j in enumerate(n_splits):
...
for i, j in enumerate(n_splits):
    ...
    t, p = stats.ttest_ind(b_train_test_mse_cleaned[i], baseline_test_mse_cleaned, equal_var=False, alternative="less")
