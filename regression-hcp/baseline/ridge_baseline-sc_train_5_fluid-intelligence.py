...
hcp_fluid_intelligence_train_csv = '../../data_hcp/hcp-cognition/hcp_fluid-intelligence/hcp_fluid-intelligence_prediction-model_train_5.csv'
...
# Save as pickle
result_dir = f'./data/baseline-sc_train_5_fluid-intelligence/ridge/outer_{n_outer_splits}_inner_{n_inner_splits}'
