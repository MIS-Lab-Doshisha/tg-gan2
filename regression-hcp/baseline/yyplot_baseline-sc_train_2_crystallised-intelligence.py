...
fig_dir = f'./fig/baseline-sc_train_2_crystallised-intelligence/{algorithm}/'
...
# ------ Load result ------ #
outer_data_pkl = f'./data/baseline-sc_train_2_crystallised-intelligence/{algorithm}/outer_{n_outer_splits}_inner_{n_inner_splits}/outer.pkl'
...
score_pkl = f'./data/baseline-sc_train_2_crystallised-intelligence/{algorithm}/outer_{n_outer_splits}_inner_{n_inner_splits}/score.pkl'
