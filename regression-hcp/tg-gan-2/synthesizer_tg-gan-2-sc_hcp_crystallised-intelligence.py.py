...
checkpoint_encoder_pth = f'../../tg-gan-2-hcp/data_hcp/tg-gan-sc_hcp_crystallised-intelligence/dr_{dropout}_alpha_{alpha}/checkpoint_encoder.pth'
checkpoint_decoder_pth = f'../../tg-gan-2-hcp/data_hcp/tg-gan-sc_hcp_crystallised-intelligence/dr_{dropout}_alpha_{alpha}/checkpoint_decoder.pth'
...
train_datasets = HCPSC(participants_csv='../../data_hcp/hcp-cognition/hcp_crystallised-intelligence/hcp_crystallised-intelligence_prediction-model_train_baseline.csv',
                       target='crystallised intelligence', transforms=transform, data_dir='../../data_hcp/structural_connectivity_360')
...
# ------ Save ------ #
data_dir = f'../../data_hcp/tg-gan-2-sc_hcp_crystallised-intelligence/dr_{dropout}_alpha_{alpha}'
os.makedirs(data_dir, exist_ok=True)

synthesized_matrices_pkl = f'{data_dir}/tg-gan-2-sc_hcp_crystallised-intelligence_n-splits_{n_splits}_matrices.pkl'
with open(synthesized_matrices_pkl, mode='wb') as f:
    pickle.dump(synthesized_matrices, f)

synthesized_targets_pkl = f'{data_dir}/tg-gan-2-sc_hcp_crystallised-intelligence_n-splits_{n_splits}_targets.pkl'
