...
test_mse.to_csv('./tg-gan-2-sc_hcp_crystallised-intelligence_test_mse.csv')
test_r.to_csv('./tg-gan-2-sc_hcp_crystallised-intelligence_test_pearson-r.csv')
...
fig.savefig('./fig/tg-gan-2-sc_hcp_crystallised-intelligence_lasso_test_rmse.pdf', transparent=True)
fig.savefig('./fig/tg-gan-2-sc_hcp_crystallised-intelligence_lasso_test_rmse.png', dpi=700)
...
fig.savefig('./fig/tg-gan-2-sc_hcp_crystallised-intelligence_lasso_test_r.pdf', transparent=True)
fig.savefig('./fig/tg-gan-2-sc_hco_crystallised-intelligence_lasso_test_r.png', dpi=700)
