...
fig_dir = f'./fig/wgan-gp-sc_hcp_fluid-intelligence/{algorithm}/n_splits_{n_splits}'
...
# ------ Load result ------ #
outer_data_pkl = f'./data/wgan-gp-sc_hcp_fluid-intelligence/{algorithm}/n_splits_{n_splits}/outer_{n_outer_splits}_inner_{n_inner_splits}/outer.pkl'
...
score_pkl = f'./data/wgan-gp-sc_hcp_fluid-intelligence/{algorithm}/n_splits_{n_splits}/outer_{n_outer_splits}_inner_{n_inner_splits}/score.pkl'
