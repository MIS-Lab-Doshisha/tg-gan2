...
test_mse.to_csv('./wgan-gp-sc_hcp_fluid-intelligence_test_mse.csv')
test_r.to_csv('./wgan-gp-sc_hcp_fluid-intelligence_test_pearson-r.csv')
...
fig.savefig('./fig/wgan-gp-sc_hcp_fluid-intelligence_ridge_test_rmse.pdf', transparent=True)
fig.savefig('./fig/wgan-gp-sc_hcp_fluid-intelligence_ridge_test_rmse.png', dpi=700)
...
fig.savefig('./fig/wgan-gp-sc_hcp_fluid-intelligence_ridge_test_r.pdf', transparent=True)
fig.savefig('./fig/wgan-gp-sc_hco_fluid-intelligence_ridge_test_r.png', dpi=700)
