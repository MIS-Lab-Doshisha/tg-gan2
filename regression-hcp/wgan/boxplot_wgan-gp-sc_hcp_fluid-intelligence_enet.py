...
# baseline
baseline_score_pkl = f'../baseline/data/baseline-sc_fluid-intelligence/{algorithm}/outer_{n_outer_splits}_inner_{n_inner_splits}/score.pkl'
...
wgan_test_r_removed = []
for i in n_splits:
    wgan_score_pkl = f'./data/wgan-gp-sc_hcp_fluid-intelligence/{algorithm}/n_splits_{i}/outer_{n_outer_splits}_inner_{n_inner_splits}/score.pkl'
...
test_mse.to_csv('./wgan-gp-sc_hcp_fluid-intelligence_enet_test_mse.csv')
test_r.to_csv('./wgan-gp-sc_hcp_fluid-intelligence_enet_test_pearson-r.csv')
...
fig.savefig('./fig/wgan-gp-sc_hcp_fluid-intelligence_enet_test_rmse.pdf', transparent=True)
fig.savefig('./fig/wgan-gp-sc_hcp_fluid-intelligence_enet_test_rmse.png', dpi=700)
...
fig.savefig('./fig/wgan-gp-sc_hcp_fluid-intelligence_enet_test_r.pdf', transparent=True)
fig.savefig('./fig/wgan-gp-sc_hco_fluid-intelligence_enet_test_r.png', dpi=700)
