...
checkpoint_encoder_pth = f'../../wgan-hcp/data_hcp/wgan-gp-sc_hcp_crystallised-intelligence/dr_{dropout}/checkpoint_encoder.pth'
checkpoint_decoder_pth = f'../../wgan-hcp/data_hcp/wgan-gp-sc_hcp_crystallised-intelligence/dr_{dropout}/checkpoint_decoder.pth'
...
# ------ Save ------ #
data_dir = f'../../data_hcp/wgan-gp-sc_hcp_crystallised-intelligence/dr_{dropout}'
os.makedirs(data_dir, exist_ok=True)

synthesized_matrices_pkl = f'{data_dir}/wgan-gp-sc_hcp_crystallised-intelligence_n-splits_{n_splits}_matrices.pkl'
with open(synthesized_matrices_pkl, mode='wb') as f:
    pickle.dump(synthesized_matrices, f)

synthesized_targets_pkl = f'{data_dir}/wgan-gp-sc_hcp_crystallised-intelligence_n-splits_{n_splits}_targets.pkl'
