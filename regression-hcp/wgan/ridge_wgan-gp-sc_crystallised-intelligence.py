...
# Fake
synthesized_connectivity_pkl = f'../../data_hcp/wgan-gp-sc_hcp_crystallised-intelligence/dr_{dropout}/wgan-gp-sc_hcp_crystallised-intelligence_n-splits_{n_splits}_matrices.pkl'
synthesized_target_pkl = f'../../data_hcp/wgan-gp-sc_hcp_crystallised-intelligence/dr_{dropout}/wgan-gp-sc_hcp_crystallised-intelligence_n-splits_{n_splits}_targets.pkl'
...
# Save as pickle
result_dir = f'./data/wgan-gp-sc_hcp_crystallised-intelligence/ridge/n_splits_{n_splits}/outer_{n_outer_splits}_inner_{n_inner_splits}'
