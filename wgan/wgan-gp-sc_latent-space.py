...
for dr in dropout:
    ...
    fig.savefig(f'./fig/wgan-gp-sc/modified_training_latent_space_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc/modified_training_latent_space_pca_dr_{dr}.png', dpi=700)
    ...
    fig.savefig(f'./fig/wgan-gp-sc/modified_training_latent_score_corr_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc/modified_training_latent_score_corr_pca_dr_{dr}.png', dpi=700)
    ...
    ax.set_xlabel(f'PC 1 [{evr[0]:.2f}%]', fontsize=18)
    ax.set_ylabel(f'PC 2 [{evr[1]:.2f}%]', fontsize=18)
    # ax.set_title(f'[Validation] Dropout: {dr}', fontsize=20)
    ax.grid(linestyle='dotted', linewidth=1.5)
    ...
    fig.savefig(f'./fig/wgan-gp-sc/modified_validation_latent_space_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc/modified_validation_latent_space_pca_dr_{dr}.png', dpi=700)
    ...
    fig.savefig(f'./fig/wgan-gp-sc/modified_validation_latent_score_corr_pca_dr_{dr}.pdf', transparent=True)
    fig.savefig(f'./fig/wgan-gp-sc/modified_validation_latent_score_corr_pca_dr_{dr}.png', dpi=700)
