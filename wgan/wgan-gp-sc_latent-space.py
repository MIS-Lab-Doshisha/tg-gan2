...
for dr in dropout:
    ...
    # fig = plt.figure(figsize=(10, 7))
    # ax = fig.add_subplot()
    # mappable = ax.scatter(z_tsne[:, 0], z_tsne[:, 1], c=target, edgecolors='#000000', cmap='OrRd', linewidth=1.0, s=50)
    ...
    # cbar.ax.tick_params(labelsize=15)
    #
    # fig.savefig(f'./fig/wgan-gp-sc/validation_latent_space_tSNE_dr_{dr}.pdf', transparent=True)
