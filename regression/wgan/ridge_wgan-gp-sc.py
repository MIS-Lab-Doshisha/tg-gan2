...
# Fake
synthesized_connectivity_pkl = f'../../data/wgan-gp-sc/dr_{dropout}/wgan-gp-sc_n-splits_{n_splits}_matrices.pkl'
synthesized_target_pkl = f'../../data/wgan-gp-sc/dr_{dropout}/wgan-gp-sc_n-splits_{n_splits}_targets.pkl'
...
# Save as pickle
result_dir = f'./data/wgan-gp-sc/ridge/n_splits_{n_splits}/outer_{n_outer_splits}_inner_{n_inner_splits}'
