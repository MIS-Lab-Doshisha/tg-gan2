...
# [wgan-gp] Synthesize new adjacency matrices and objective scores
# ------ Setting ------ #
dropout = 0.1
n_splits = 5
...
# ------ Save ------ #
data_dir = f'../../data/wgan-gp-sc/dr_{dropout}'
os.makedirs(data_dir, exist_ok=True)

synthesized_matrices_pkl = f'{data_dir}/wgan-gp-sc_n-splits_{n_splits}_matrices.pkl'
with open(synthesized_matrices_pkl, mode='wb') as f:
    pickle.dump(synthesized_matrices, f)

synthesized_targets_pkl = f'{data_dir}/wgan-gp-sc_n-splits_{n_splits}_targets.pkl'
