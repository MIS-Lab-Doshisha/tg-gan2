...
X = load_structural_connectivity(participants_csv=nihtoolbox_disc_csv,
...
y = load_score(participants_csv=nihtoolbox_disc_csv, target='nihtoolbox')
...
# Save as pickle
result_dir = f'./data/baseline-sc/ridge/outer_{n_outer_splits}_inner_{n_inner_splits}'
