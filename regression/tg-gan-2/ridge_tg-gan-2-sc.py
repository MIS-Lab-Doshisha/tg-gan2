...
sys.path.append('.')
from utils.load_dataset import load_score, load_structural_connectivity


# [tg-gan-2] Ridge regression
...
# Real
nihtoolbox_disc_csv = '../../data/nihtoolbox_disc.csv'
X_real = load_structural_connectivity(participants_csv=nihtoolbox_disc_csv,
...
y_real = load_score(participants_csv=nihtoolbox_disc_csv, target='nihtoolbox')

# Fake
synthesized_connectivity_pkl = f'../../data/tg-gan-2-sc/dr_{dropout}_alpha_{alpha}/tg-gan-2-sc_n-splits_{n_splits}_matrices.pkl'
synthesized_target_pkl = f'../../data/tg-gan-2-sc/dr_{dropout}_alpha_{alpha}/tg-gan-2-sc_n-splits_{n_splits}_targets.pkl'
...
# Save as pickle
result_dir = f'./data/tg-gan-2-sc/ridge/n_splits_{n_splits}/outer_{n_outer_splits}_inner_{n_inner_splits}'
