...
for i in n_splits:
    tggan_score_pkl = f'./data/tg-gan-2-sc/{algorithm}/n_splits_{i}/outer_{n_outer_splits}_inner_{n_inner_splits}/score.pkl'
...
test_mse.to_csv('./tg-gan-2-sc_test_mse.csv')
test_r.to_csv('./tg-gan-2-sc_test_pearson-r.csv')

# Box plot
fig = plt.figure()
ax = fig.add_subplot()

color_pallete = ['#f2f0f7', '#cbc9e2', '#9e9ac8', '#756bb1', '#54278f']
...
fig.savefig('./fig/tg-gan-2-sc_ridge_test_rmse.pdf', transparent=True)
fig.savefig('./fig/tg-gan-2-sc_ridge_test_rmse.png', dpi=700)
...
fig.savefig('./fig/tg-gan-2-sc_ridge_test_r.pdf', transparent=True)
fig.savefig('./fig/tg-gan-2-sc_ridge_test_r.png', dpi=700)
