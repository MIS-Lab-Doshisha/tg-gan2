...
for dr in dropout:
    for a in alphas:
        ...
        checkpoint_encoder_pth = f'./data_hcp_v2/tg-gan-sc_hcp_crystallised-intelligence/dr_{dr}_alpha_{a}/checkpoint_encoder_epoch_500.pth'
        checkpoint_decoder_pth = f'./data_hcp_v2/tg-gan-sc_hcp_crystallised-intelligence/dr_{dr}_alpha_{a}/checkpoint_decoder_epoch_500.pth'
        ...
        fig.savefig(f'./fig_v2/training_latent_space_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligence/training_latent_space_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligence/training_latent_score_corr_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligence/training_latent_score_corr_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligence/validation_latent_space_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligencec/validation_latent_space_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligence/validation_latent_score_corr_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig_v2/tg-gan-2-sc_hcp_crystallised-intelligence/validation_latent_score_corr_pca_dr_{dr}_alpha_{a}.png', dpi=700)
