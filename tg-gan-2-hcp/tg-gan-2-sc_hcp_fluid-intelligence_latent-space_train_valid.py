...
for dr in dropout:
    for a in alphas:
        ...
        checkpoint_encoder_pth = f'./data_hcp/tg-gan-sc_hcp_fluid-intelligence/dr_{dr}_alpha_{a}/checkpoint_encoder.pth'
        checkpoint_decoder_pth = f'./data_hcp/tg-gan-sc_hcp_fluid-intelligence/dr_{dr}_alpha_{a}/checkpoint_decoder.pth'
        ...
        fig.savefig(f'./fig/_/training_latent_space_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligence/training_latent_space_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligence/training_latent_score_corr_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligence/training_latent_score_corr_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligence/validation_latent_space_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligencec/validation_latent_space_pca_dr_{dr}_alpha_{a}.png', dpi=700)
        ...
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligence/validation_latent_score_corr_pca_dr_{dr}_alpha_{a}.pdf', transparent=True)
        fig.savefig(f'./fig/tg-gan-2-sc_hcp_fluid-intelligence/validation_latent_score_corr_pca_dr_{dr}_alpha_{a}.png', dpi=700)
